...
const localeSchema = new mongoose.Schema(
  {
    ...
    selectCategory: {
      content: {
        ...
        body: {
          type: String,
          default: 'Choose a category that’s closest to the kind of help you need',
        },
    ...
    addContact: {
      content: {
        ...
        body: {
          type: String,
          default: 'Write your address and phone number so your assigned helper can find and contact you.',
        },
      },
      placeholders: {
