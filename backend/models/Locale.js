...
const localeSchema = new mongoose.Schema(
  {
    ...
    landing: {
      content: {
        ...
        body: {
          type: String,
          default:
            "Zelos Community Helpdesk connects people who need help with volunteers who are willing to help others",
        },
      },
      buttons: {
    ...
    selectCategory: {
      content: {
        ...
        body: {
          type: String,
          default:
            "Choose a category that’s closest to the kind of help you need",
        },
    ...
    writeRequest: {
      content: {
        ...
        body: {
          type: String,
          default: "Please describe what kind of help you need.",
        },
      },
      placeholders: {
        request: {
          type: String,
          default:
            "For example: I need groceries delivered. I will place the order online myself and would like a volunteer to pick them up and bring them home for me",
        },
      },
      buttons: {
    ...
    addContact: {
      content: {
        ...
        body: {
          type: String,
          default:
            "Write your address and phone number so your assigned helper can find and contact you.",
        },
      },
      placeholders: {
        ...
        participants: { type: String, default: "Max Participants" },
        date: { type: String, default: "Date" },
        startTime: { type: String, default: "Start Time" },
        endTime: { type: String, default: "End Time" },
      },
      buttons: {
        back: { type: String, default: "Back" },
    ...
    confirmation: {
      content: {
        header: {
          type: String,
          default: "Your help request has been received",
        },
        body: {
          type: String,
          default:
            "We are now processing your request and will send you a message as soon as your request has been accepted. Have a nice day!",
        },
      },
      buttons: {
  ...
  async add(name, code) {
    ...
    if (result) {
      const err = createError(409, {
        message: {
          status: "error",
          message: `${result.name} (${result.code}) already exists`,
        },
      });
      throw err;
    }
